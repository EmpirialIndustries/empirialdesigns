...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen bg-white/95 backdrop-blur-lg flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-32">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-16 max-w-3xl mx-auto leading-relaxed animate-fade-in font-light" style={{ animationDelay: '0.4s' }}>
