  ...
  return (
    <section id="home" className="min-h-screen gradient-bg flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-20 right-10 w-[500px] h-[500px] bg-gray-800 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gray-600 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-lg elegant-border rounded-full px-8 py-4 mb-12 animate-scale-in elegant-shadow">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <Button 
              size="lg" 
              className="gradient-primary text-primary-foreground font-bold px-12 py-6 text-xl group hover:scale-105 transition-all duration-300 elegant-shadow"
            >
              View Our Services
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-2 border-black text-black hover:bg-black hover:text-white px-12 py-6 text-xl hover:scale-105 transition-all duration-300 font-bold"
            >
              Get In Touch
            </Button>
          </div>
